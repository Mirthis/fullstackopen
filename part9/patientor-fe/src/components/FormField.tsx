...
interface BaseSelectFieldOption {
  label: string;
}

export interface GenderSelectOption extends BaseSelectFieldOption {
  type: "gender";
  value: Gender;
}

export interface RatingSelectOption extends BaseSelectFieldOption {
  type: "rating";
